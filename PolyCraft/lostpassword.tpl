...
<tr>
			<td width="43%" class="label">
				<span class="reg_info">Ваш игровой ник</span>
				<br/>
				<span class="reg_info2">Который вы использовали при регистрации</span>
			</td>
			<td class="reg_form_right">
				<span class="icon-tf icon-user">
				</span>
				<input placeholder="Например: Sample" autocomplete="off" type="text" name="name" style="margin-right: 6px;" class="reg_tf" />
				<div class="entrance_line_first">
				</div>
		...
		<tr>
			<td class="label">
				<span class="reg_info">Ваша почта (E-mail)
				<br/>
				<span class="reg_info2">Которую вы использовали при регистрации</span>
			</td>
			<td class="reg_form_right">
				<span class="icon-tf icon-mail">
				</span>
				<input placeholder="Например: sample@yandex.ru" autocomplete="off" type="text" name="lostname" class="reg_tf" />
